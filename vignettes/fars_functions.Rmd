...
### `fars_map_state`
The `fars_map_state`function takes the state numbe and year as inpuut and displays the place of the fata linjuries for the selected state and year on a map. 
